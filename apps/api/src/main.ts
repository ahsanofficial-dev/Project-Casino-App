...
async function bootstrap() {
  ...
  if (process.env.NODE_ENV === 'production' && (!process.env.WEB_ORIGIN || !process.env.WEB_ORIGIN.startsWith('https://'))) throw new Error('WEB_ORIGIN must use HTTPS in production');
